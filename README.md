# Compose Foundation — design artifacts
...
**[▶ Open the rendered catalog (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/m3-catalog/blob/design-artifacts/compose-foundation/index.html)**
...
**[▶ Open the SVG↔PNG comparison (htmlpreview)](https://htmlpreview.github.io/?https://github.com/yschimke/m3-catalog/blob/design-artifacts/compose-foundation/compare.html)**
...
**[▶ Open this catalog in the live preview server](https://preview.coo.ee/compose-foundation/)**

The same rendered components, served live by `compose-preview serve --catalogs compose-foundation` —
...
| --- | --- |
| Components | **7** |
| Rendered images (PNG) | **14** |
| Editable wireframes (SVG) | **7** |
...
| Path | What it is |
| --- | --- |
| `index.html` | Self-contained gallery — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/m3-catalog/blob/design-artifacts/compose-foundation/index.html) |
| `compare.html` | SVG↔PNG comparison with a live structural-similarity score — [open via htmlpreview](https://htmlpreview.github.io/?https://github.com/yschimke/m3-catalog/blob/design-artifacts/compose-foundation/compare.html) |
...
- **Customise** — open the [live preview server](https://preview.coo.ee/compose-foundation/) (or any image's `livePreview` link in `catalog.json`) to re-render a component under different themes / locales / devices.
